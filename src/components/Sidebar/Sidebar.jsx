...
export default function Sidebar() {
    return (
        <div className="hidden md:flex w-64 flex-shrink-0 min-h-[calc(100vh-4rem)] border-r border-surfaceBorder bg-surface/30 flex-col overflow-y-auto custom-scrollbar">
